# cargo-read [![CI](https://img.shields.io/github/actions/workflow/status/imazen/cargo-read/ci.yml?style=flat-square&label=CI)](https://github.com/imazen/cargo-read/actions/workflows/ci.yml) [![crates.io](https://img.shields.io/crates/v/cargo-read?style=flat-square)](https://crates.io/crates/cargo-read) [![lib.rs](https://img.shields.io/crates/v/cargo-read?style=flat-square&label=lib.rs&color=blue)](https://lib.rs/crates/cargo-read) [![docs.rs](https://img.shields.io/docsrs/cargo-read?style=flat-square)](https://docs.rs/cargo-read) [![License](https://img.shields.io/crates/l/cargo-read?style=flat-square)](https://github.com/imazen/cargo-read/blob/master/LICENSE)
